...
require go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.20.0 // indirect

require (
	github.com/cenkalti/backoff/v4 v4.3.0 // indirect
	github.com/grpc-ecosystem/grpc-gateway/v2 v2.22.0 // indirect
	go.opentelemetry.io/proto/otlp v1.1.0 // indirect; indirect	golang.org/x/crypto v0.19.0 // indirect
